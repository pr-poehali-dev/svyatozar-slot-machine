      ...
      {showPayment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm">
          <div className="text-center px-4">
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-green-500 to-green-600 flex items-center justify-center animate-pulse">
              <Icon name="Loader2" size={48} className="text-white animate-spin" />
            </div>
            <h2 className="text-3xl font-black text-white mb-4">
              {activeTab === 'deposit' ? 'Переход в банк...' : 'Вывод средств...'}
            </h2>
